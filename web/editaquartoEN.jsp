    ...
    <body>
        ...
        %> 
                <body> 
                    ...
                    %>
                    <div class="container">
                    <form action="recebeeditaquartoEN.jsp" method="POST" id="bomasilo" action="" >
                        <h3>Edit Room</h3> 
                        ...
                        <input type="submit" value="Edit" onclick="location.href = 'consultaquartoEN.jsp';" />
                        <input type="reset" value="Cancel" onclick="location.href = 'consultaquartoEN.jsp';" />
                    </form>
                </body>             
</html>
