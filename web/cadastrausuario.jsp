...
<html>
    ...
    <body>
        ...
        <div class="container">
            <form action="recebedadosusuario.jsp" method="POST" id="bomasilo" action="" >
                ...
                <fieldset>
                    ...
                    <fieldset> 
                        <label for="adm"><input type="radio" id="adm" name="tipoAcesso" value="adm"> Administrador</label>
                    </fieldset>
                    <fieldset>
                        <label for="familiar"><input type="radio" id="familiar" name="tipoAcesso" value="familiar"> Familiar</label>
                    </fieldset>
                    <fieldset>
                        <label for="profSaude"><input type="radio" id="proSaude" name="tipoAcesso" value="profsaude"> Prof. Saúde</label>
                    </fieldset>
                </fieldset>
                <br />
