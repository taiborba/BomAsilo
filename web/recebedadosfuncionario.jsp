...
<%
    ...
    if (fun.incluirFuncionario()) {
            response.sendRedirect("cadastrarfuncionario.jsp?pmensagem=" +URLEncoder.encode("Funcionário salvo com sucesso", "UTF-8"));
    } else {
            response.sendRedirect("cadastrarfuncionario.jsp?pmensagem=" +URLEncoder.encode("Problemas ao salvar funcionário", "UTF-8"));
    }
