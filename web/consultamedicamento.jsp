    ...
    <body>
        ...
        <tbody>
            ...
            <tr> <!-- para cada linha tem que ter uma <tr> -->
                ...
                <td>Não</td>
                <%}%>
                <td><%out.write("<a href=editamedicamento.jsp?idMedicamento=" + m.getIdMedicamento() + ">" + "<i class='fas fa-edit' style='color=black'></i>" + "</a>");%></td> 
                <td>
...
<script>
    ...
    function mostrarExclusao(medicamento) {
        ...
        link.href = "excluimedicamento.jsp?idMedicamento=" + medicamento;
    }
</script>
</body>
</html>
