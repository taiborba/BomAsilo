        ...
        <body>
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><%out.write("<a href=editaclinico.jsp?idClinico=" + c.getIdClinico() + ">" + "<i class='fas fa-edit' style='color=black'></i>" + "</a>");%></td> 
                        <td>
            ...
            <script>
                ...
                function mostrarExclusao(clinico) {
                    ...
                    link.href = "excluiclinico.jsp?idClinico=" + clinico;
                }
            </script>                  
        </body>
</html>