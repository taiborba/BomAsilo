        ...
        <tbody>
            ...
            <tr>
                ...
                <td><% out.write(e.getUf()); %></td>
                 <td><%out.write("<a href=editaendereco.jsp?idEndereco=" + e.getIdEndereco() + ">" + "<i class='fas fa-edit' style='color=black'></i>" + "</a>");%></td> 
                <td>
...
<script>
    ...
    function mostrarExclusao(endereco) {
        ...
        link.href = "excluiendereco.jsp?idEndereco=" + endereco;
    }
</script>                  
</body>
</html>
