...
<html>
    ...
    <body>
        ...
        %>
                ...
                <fieldset>
                    <label>Selecione a Prescrição </label> 
                    <select name="idPrescricao">
                        <option value="" hidden disabled selected> --Selecione a Prescrição--</option>
                        <% for (Prescricao pr : pre) { %>
                        <option value="<%out.write("" + pr.getIdPrescricao());%>">
                            <% out.write(pr.getDescPosologia() + " - " + pr.getDataConsulta()); %></option><%}%>
                    </select> </br>
                    <a href="cadastraprescricao.jsp" target="_blank"> Cadastrar Prescrição </a>
                </fieldset>
